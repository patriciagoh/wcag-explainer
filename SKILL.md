...
5. Tell the user the app is ready and give them the URL. Suggest they leave the dev server running and stop it themselves (Ctrl-C in the relevant terminal) when done.
